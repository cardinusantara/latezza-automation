# Graph Report - latezza-automation  (2026-06-20)

## Corpus Check
- 84 files · ~56,386 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 773 nodes · 1020 edges · 55 communities (43 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `67520b7c`
...
Cohesion: 0.05
Nodes (42): 1. Kategori: Umum, 2. Kategori: Statistik Dashboard, 3. Kategori: CRM (Manajemen Pelanggan), 4. Kategori: Catalog (Manajemen Produk), 5. Kategori: Integrasi WhatsApp, 6. Kategori: Pengaturan & Prompt, 7. Kategori: Automasi Ads & Creative, 8. Kategori: Automasi Follow-Up (+34 more)
...
Cohesion: 0.05
Nodes (38): 2026-06-17 (afternoon), 2026-06-17 (evening), 2026-06-17 (morning — initial build), 2026-06-18, 2026-06-19, 2026-06-20, Ads Report — dashboard tab, AI Creative Ad Ideas & Copywriting Audit (+30 more)
...
Cohesion: 0.07
Nodes (40): Actions(), ActionsProps, CreativeIdea, CreativeReportData, Lead, OverviewProps, Stats, Product (+32 more)
...
Cohesion: 0.11
Nodes (18): dependencies, dotenv, fastify, @fastify/cors, @fastify/static, @google/generative-ai, node-cron, pg (+10 more)
...
Cohesion: 0.13
Nodes (10): agent, connectSession(), connectToWhatsApp(), db, {
  default: makeWASocket,
  useMultiFileAuthState,
  DisconnectReason,
  downloadMediaMessage
}, fs, path, rateLimitCache (+2 more)

### Community 17 - "Community 17"
Cohesion: 0.14
Nodes (12): agent, db, fs, path, agentTools, buildSystemInstructions(), db, defaultMaxHistory (+4 more)
...
Cohesion: 0.22
Nodes (7): adsService, agent, db, followupService, fs, path, whatsappService
...
Cohesion: 0.32
Nodes (6): db, fetchMetaAdsCreatives(), fetchMetaAdsInsights(), { GoogleGenerativeAI }, runCreativeAnalysis(), whatsappService
...
## Knowledge Gaps
- **444 isolated node(s):** `fs`, `path`, `{ GoogleGenerativeAI }`, `name`, `version` (+439 more)
