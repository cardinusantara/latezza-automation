# Graph Report - latezza-automation  (2026-06-24)

## Corpus Check
- 113 files · ~91,383 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1023 nodes · 1349 edges · 89 communities (71 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca687f6c`
...
9. `Styling & Customization` - 12 edges
10. `Dokumentasi API Backend` - 12 edges
...
Cohesion: 0.04
Nodes (46): adding a new AI tool, adding a new API route, adding a new frontend tab/panel, adding a new settings key, ADDING NEW FEATURES — PATTERNS TO FOLLOW, ads & creative ideas, AI AGENT (src/agent.js), AI CREATIVE AD CONTENT IDEAS (src/services/creative.js) (+38 more)
...
Cohesion: 0.10
Nodes (22): buildKpis(), DailyTrendItem, FeatureBreakdownItem, GeminiAnalyticsPanelProps, getDateRangeLabel(), Lead, MessageSummaryData, MtdStats (+14 more)
...
Cohesion: 0.09
Nodes (22): agent, db, fs, path, agentTools, buildSystemInstructions(), db, defaultMaxHistory (+14 more)
...
Cohesion: 0.40
Nodes (5): db, { GoogleGenerativeAI }, processSingleFollowUp(), runProactiveFollowUps(), whatsappService
...
Cohesion: 0.18
Nodes (10): 2026-06-20, 2026-06-22, 2026-06-24, Backend Refactoring & SonarQube Code Quality Improvements, CHANGELOG — Latezza Cake WhatsApp AI Agent, DATA NOTES, Optimized Creative Analysis Sourcing & CSV Context, Voice Message Comprehension & Audio Player (+2 more)
...
Cohesion: 0.12
Nodes (16): 📄 `backend/ads-analysis/automation.js` (27 issues), 📄 `backend/ads-analysis/template.html` (17 issues), 📄 `backend/src/db.js` (11 issues), 📄 `backend/src/routes.js` (22 issues), 📄 `backend/src/services/creative.js` (11 issues), By Severity, By Type, 📄 `frontend/src/components/ChatInbox.tsx` (27 issues) (+8 more)
...
Cohesion: 0.10
Nodes (19): ChatInbox(), ChatInboxProps, ChatMessage, ChatMessageBubbleProps, ConversationBoxPanel(), ConversationBoxPanelProps, ConversationListPanelProps, CrmPanelProps (+11 more)

### Community 84 - "Community 84"
Cohesion: 0.17
Nodes (11): Product, ProductsProps, WhatsAppSession, mockProducts, Dialog(), DialogContent(), DialogDescription(), DialogFooter() (+3 more)

### Community 85 - "Community 85"
Cohesion: 0.13
Nodes (12): AdsReport(), AdsReportControlsProps, AdsReportHeaderProps, AdsReportViewPanelProps, calculatePresetDates(), CsvMetadata, getLocalDateString(), getStepState() (+4 more)

### Community 86 - "Community 86"
Cohesion: 0.23
Nodes (6): SettingsProps, SettingsState, Button(), buttonVariants, Switch(), Textarea()

### Community 87 - "Community 87"
Cohesion: 0.32
Nodes (8): ActionsProps, CreativeIdea, CreativeReportData, Card(), CardContent(), CardDescription(), CardHeader(), CardTitle()

### Community 88 - "Community 88"
Cohesion: 0.22
Nodes (5): Actions(), SidebarProps, Lead, Stats, API_BASE_URL

## Knowledge Gaps
- **565 isolated node(s):** `$schema`, `plugin`, `@opencode-ai/plugin`, `fs`, `path` (+560 more)
...
- **Why does `Overview()` connect `UI Actions Component` to `Community 55`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `cn()` connect `Mobile Hook` to `UI Actions Component`, `Community 83`, `Community 84`, `Community 86`, `Community 87`?**
